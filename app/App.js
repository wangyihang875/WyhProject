        ...
        return (
            <View style={{flex:1}}>
                <View style={styles.heading}>
                    <Text style={styles.headingText}>My List App1</Text>
                </View>
                ...
                <View style={{flex:1}}>
                    {list.map((l, i) => {
                        return <View key={i} style={styles.itemContainer}>
                            <Text
                                style={styles.item}
                                onPress={()=>this.addItemToList(l)}>{l.name.toUpperCase()}</Text>
                            <Text
                                style={styles.deleteItem}
                                onPress={()=>this.removeListItem(l)}>Remove</Text>
                        </View>
                    })}
                </View>
                <TouchableHighlight
                    ...
                    onPress={
                        this.state.text === '' ? ()=>this.toggleInput()
                            : ()=>this.addListItem()
                    }
                    style={styles.button}>
